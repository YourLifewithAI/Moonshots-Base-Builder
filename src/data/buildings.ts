...
export const BUILDINGS: Record<BuildingId, BuildingDef> = {
  ...
  smelter: {
    ...
    inputs: { regolith: 2 }, outputs: { metals: 0.5, oxygen: 0.25 }, upkeepParts: 2, priority: 2,
    pro: 'Metals — and breathable oxygen as a byproduct. Industry keeps you alive.',
  ...
  hydroponics: {
    ...
    inputs: { water: 0.3 }, outputs: { food: 0.35 }, upkeepParts: 1, priority: 1,
    moraleDelta: 5,
  ...
  lab: {
    id: 'lab', name: 'Research Lab', category: 'science', era: 2,
    footprint: [2, 2], height: 5,
