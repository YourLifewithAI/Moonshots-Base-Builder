/** 49 technologies in 7 swimlanes × 8 eras — the robots-first arc of lunar
...
export type TechId =
  ...
  | 'waferFab' | 'acceleratorDesign' | 'radHardProcess' | 'cleanroomRobotics' | 'roverAutonomy' | 'orbitalProspector'
  | 'btVolcanicGlass'
  // era 5 — lunar compute
  | 'lunarDataCenter' | 'dynamicClocking' | 'cryoRadiators' | 'autonomousHaulage' | 'crewWellness'
...
export const TECHS: Record<TechId, TechDef> = {
  ...
  roverAutonomy: {
    ...
    costData: 260, costGoods: { parts: 20 }, requires: ['constructionRobotics'],
    effects: [
  ...
  autonomousHaulage: {
    ...
    costData: 440, costGoods: { parts: 30 }, requires: ['roverAutonomy'],
    effects: [
