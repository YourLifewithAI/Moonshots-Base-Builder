...
test('data: 125 techs, each with a visual line, a generated pro and con, relevant wherever it shows', async ({ page }) => {
  ...
  expect(r.n).toBe(125); // docs/12's 92, the Builder's 12, docs/14's 19 destiny techs … and the rest
