...
| Server Monolith (5) · ◉ Fleet OS | S | −26 kW → 0.9 data/s; transfer cap +2.2/s | Counts as a Data Center wherever one is read; 2×2, 16 m | A Data Center's work on less than half the ground | A network hub: everything within 60 m links to it |
